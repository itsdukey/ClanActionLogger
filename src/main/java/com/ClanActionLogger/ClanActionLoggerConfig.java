...
public interface ClanActionLoggerConfig extends Config
{
	...
	@ConfigItem(
			keyName = "setupNotice",
			name = "<html><font color='#e0a32d'>⚠️ Please read the guides below to properly set up the plugin.</font></html>",
	...
	@ConfigItem(
			...
			name = "<html><body width='175'>"
					...
					+ "<b>Clan Name:</b> Locks the plugin to only monitor events for this exact clan.<br><br>"
					+ "<b>Your RSN Here:</b> Authorizes the plugin to execute only when logged into these specific account(s).<br><br>"
					+ "<b>Discord Webhook URL:</b> The destination channel where your logs will be delivered.<br><br>"
	...
	@ConfigItem(
			...
			name = "<html><body width='175'>"
					+ "<font color='#A0A0A0' face='sans-serif' size='3'>"
					+ "<center><font color='#e0a32d'><b>Discord Admins</b></font></center><br>"
					+ "1. Create a Discord text channel.<br><br>"
					+ "2. Edit Channel > Go to Integrations > Webhooks.<br><br>"
					+ "<center><font color='#e0a32d'><b>Everyone Else</b></font></center><br>"
